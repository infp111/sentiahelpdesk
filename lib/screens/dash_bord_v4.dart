...
class DashboardFour extends StatefulWidget {
  const DashboardFour({Key? key}) : super(key: key);

  @override
  State<DashboardFour> createState() => _DashboardFourState();
}

class _DashboardFourState extends State<DashboardFour> {
                            ...
                            child: Column(
                              ...
                              children: [
                                ExpansionTile(
                                  ...
                                  children: [
                                    Text("Facing Issues during Regsitrion Step",
                                        style: TextStyle(
                                          color: Colors.black,
                                          fontSize: 18,
